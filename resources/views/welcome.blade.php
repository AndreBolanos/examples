...
<style>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="container-fluid" style="padding-top: 5px;padding-bottom: 15px;">
                                    ...
                                    <div class="col-md-12" style="padding-right: 15px;">
                                        ...
                                        <div class="row g-1">
                                            ...
                                            <div class="d-grid gap-2 col-3 ms-auto mt-0">
                                                <button class="btn btn-secondary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Search Claim</button>
                                              </div>
                                            <hr>
                                            <div class="formDatos col-md-6">
                                            ...
                                            <div class="formDatos col-md-12 mt-1">
                                                <div class="form-check form-check-inline ps-0">
                                                    <label class="form-check-label" for="inlineCheckbox1">Is the associate a contractor/Temp?</label>
                                                  </div>
                                            ...
                                            <div class="formDatos col-md-12 mt-1">
                                                <div class="form-check form-check-inline ps-0">
                                                    <label class="form-check-label" for="inlineCheckbox1">Work related injury?</label>
                                                  </div>
                                                  <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="inlineRadioOptionsA" id="inlineRadio1" value="option1">
                                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                  </div>
                                                  <div class="form-check form-check-inline">
                                            ...
                                            <div class="formDatos col-md-6">
                                                <label for="name" class="form-label col-form-label-sm">Company that issues your payment?</label>
                                                <input type="text" class="form-control form-control-sm" id="name"
                                                    name="name" value="{{ old('name') }}" required>
                                                <b><small><span
                                                            class="text-danger error-text name_error"></span></small></b>
                                            ...
                                            <div class="formDatos col-md-6">
                                                <label for="name" class="form-label col-form-label-sm">What company does EE work for?</label>
                                                <input type="text" class="form-control form-control-sm" id="name"
                                                    name="name" value="{{ old('name') }}" required>
                                                <b><small><span
                                                            class="text-danger error-text name_error"></span></small></b>
                                ...
                                <div class="d-grid gap-2 col-3 ms-auto mt-0">
                                    <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#claimSearch">Continue</button>
                                  </div>
                            </div>
                        </div>
                    </div>
  ...
  <!-- Modal -->
  <div class="modal fade" id="claimSearch" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
